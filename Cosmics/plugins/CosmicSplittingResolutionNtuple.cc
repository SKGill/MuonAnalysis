...
//   branch_it(tree, "muon_hits_DT", nt->muon_hits_DT, "muon_hits_DT[%i][2]/s");
//   branch_it(tree, "muon_hits_CSC", nt->muon_hits_CSC, "muon_hits_CSC[%i][2]/s");
//   branch_it(tree, "muon_hits_RPC", nt->muon_hits_RPC, "muon_hits_RPC[%i][2]/s");  
...
//   branch_it(tree, "ref_muon_hits_DT", &nt->ref_muon_hits_DT, "ref_muon_hits_DT/s");
//   branch_it(tree, "ref_muon_hits_CSC", &nt->ref_muon_hits_CSC, "ref_muon_hits_CSC/s");
//   branch_it(tree, "ref_muon_hits_RPC", &nt->ref_muon_hits_RPC, "ref_muon_hits_RPC/s");
...
//   tree->SetBranchAddress("muon_hits_DT", nt->muon_hits_DT);
//   tree->SetBranchAddress("muon_hits_CSC", nt->muon_hits_CSC);
//   tree->SetBranchAddress("muon_hits_RPC", nt->muon_hits_RPC);
...
//   tree->SetBranchAddress("ref_muon_hits_DT", &nt->ref_muon_hits_DT);
//   tree->SetBranchAddress("ref_muon_hits_CSC", &nt->ref_muon_hits_CSC);
//   tree->SetBranchAddress("ref_muon_hits_RPC", &nt->ref_muon_hits_RPC);  

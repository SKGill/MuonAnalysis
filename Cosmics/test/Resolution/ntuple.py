...
datasets_data = [
    #('SPRun2012A',  '/Cosmics/Run2012A-CosmicSP-22Jan2013-v1/RAW-RECO'),
...
datasets_mc = [
    ...
    ('P10Peak',  1, '/TKCosmics_p10/Summer12-CosmicSuperPointing-COSMC_53_PEAC_cosmics-v1/GEN-SIM-RAW-RECO'),
    ('P100Peak', 2, '/TKCosmics_p100/Summer12-CosmicSuperPointing-COSMC_53_PEAC_cosmics-v1/GEN-SIM-RAW-RECO'),
    ('P500Peak', 3, '/TKCosmics_p500/Summer12-CosmicSuperPointing-COSMC_53_PEAC_cosmics-v1/GEN-SIM-RAW-RECO'),
    ]
...
[USER]
copy_data=1
email=mendres@cern.ch
check_user_remote_dir=0
storage_element=T2_DE_RWTH
return_data=0
user_remote_dir=output/Cosmics/%(sample_name)s
...
'''
    ...
    scheduler = 'condor' if not options.submit_grid else 'remoteGlidein'

...
def make_bins(bin_by, bin_extra=None):
    if bin_by == 'pt':
        bins = [
            ...
            Bin('pT5002000',  abscissa=900., min_pt=500.,  max_pt=2000.,   diff_scales=(500., 0.0025, 0.005, 0.002, 0.05, 0.07),   res_scales=(0.75, 0.75, 0.005, 0.005, 2., 2.),   pull_scales=(10., 10., 10., 10., 5.,  5. )),
            ...
            #Bin('pT7501250',   abscissa=900., min_pt=750.,  max_pt=1250.,   diff_scales=(500., 0.0025, 0.005, 0.002, 0.05, 0.07),   res_scales=(0.75, 0.75, 0.005, 0.005, 2., 2.),   pull_scales=(10., 10., 10., 10., 5.,  5. )),
        ...
        bins += [
            ...
            #Bin('pTabove1250', use_by_bin=False, min_pt=1250., max_pt=1e99,   diff_scales=(500., 0.0025, 0.005, 0.002, 0.05, 0.07),   res_scales=(2.0,  2.0,  0.005, 0.005, 2., 2.),   pull_scales=(10., 10., 10., 10., 5.,  5. )),
            #Bin('pTabove2000', use_by_bin=False, min_pt=2000., max_pt=1e99,   diff_scales=(500., 0.0025, 0.005, 0.002, 0.05, 0.07),   res_scales=(2.0,  2.0,  0.005, 0.005, 2., 2.),   pull_scales=(10., 10., 10., 10., 5.,  5. )),
            #Bin('pTabove3000', use_by_bin=False, min_pt=3000., max_pt=1e99,   diff_scales=(500., 0.0025, 0.005, 0.002, 0.05, 0.07),   res_scales=(2.0,  2.0,  0.005, 0.005, 2., 2.),   pull_scales=(10., 10., 10., 10., 5.,  5. )),
            ]
